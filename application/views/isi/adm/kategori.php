<link href="<?php echo base_url();?>assets/style.css" rel="stylesheet" />
      ...
      <div class="flash-data" data-flashdata="<?= $this->session->flashdata('sukses'); ?>"></div>
         ...
         foreach ($kategoriku as $kategori): ?>
                 ...
                 <a data-toggle="modal" data-target="#modal-edit<?php echo $kategori->id_kategori ?>" class="btn btn-success waves-effect waves-light"><span data-toggle="tooltip" data-original-title="Ubah"><font color="white"><i class="fas fa-pencil-alt"></i></font></span></a>
                ...
                <!-- Modal -->
                  <div class="modal fade text-left" id="bb" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <h6 class="modal-title"><font color='white'>Form Kategori</font></h6>
 ...
 <!-- Modal -->
 <?php $no=0; foreach ($kategoriku as $kategori): ?>
                  <div class="modal fade text-left" id="modal-edit<?php echo $kategori->id_kategori ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header bg-primary">
                      <h6 class="modal-title"><font color='white'>Edit Data Kategori</font></h6>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                      </div>
